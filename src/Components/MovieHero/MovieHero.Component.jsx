...
const MovieHero = () => {
  ...
  return (
    <>
      {/* Style for Small & Medium Tab screen  */}
      ...
      <div className='flex flex-col gap-3 lg:hidden'>
        <div className='flex flex-col-reverse gap-3 px-4 my-3'>
          ...
          <div className='flex items-center gap-3 ml:px-4 md:w-screen text-xl px-4'>
      ...
      <div className='relative hidden w-full h-full lg:block' style={{ height: "30rem" }} >
